...
const MainHeader = () => {
     return (
          <div className='bg-transparent flex items-center justify-between px-[2%] py-[10px]'>
               <div className='w-auto'><h1 className='text-main-blue-100 text-[1.8rem] font-extrabold '>Insight</h1></div>
