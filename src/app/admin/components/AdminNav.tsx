     ...
     return (
          <div className='w-[15%] h-full flex flex-col justify-between bg-main-blue-600 p-[20px] overflow-x-hidden overflow-y-auto '>
               ...
               <div className='w-full flex flex-col items-center gap-[20px]  '>
                    ...
                    <NavLink name='Institutions' dest='/admin' active={false} icon={<LuSchool />} />
                    {/* <NavLink name='Configuration' dest='/admin' active={false} icon={<MdSpaceDashboard />} /> */}
                    <NavLink name='Degree & Template' dest='/admin' active={false} icon={<GrTemplate />} />
                    <NavLink name='Report' dest='/admin' active={false} icon={<TbReportSearch />} />
                    <NavLink name='Notification' dest='/admin' active={false} icon={<IoNotifications />} />
                    <NavLink name='Setting' dest='/admin' active={false} icon={<IoSettings />} />
               </div>
               <div className='w-full flex flex-col items-center gap-[10px] '>
                    <NavLink name='Logout' dest='/admin' active={false} icon={<RiLogoutCircleLine />} />
                    <div className='w-full flex items-center gap-[5px]'>
                         <Image src='/images/admin-user.png' width={30} height={30} alt='admin user icon' className='rounded-full ' />
                         <div className='auto flex flex-col gap-[2.5px]'>
