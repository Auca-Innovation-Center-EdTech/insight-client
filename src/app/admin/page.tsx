...
const Page = () => {
     return (
     <div className='w-full h-full overflow-y-auto flex flex-col items-center justify-start gap-[10px] py-[10px]'>
          <div className='w-full flex items-center justify-start gap-[10px] px-[2%]'>
