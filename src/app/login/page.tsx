     ...
     return (
          <body className="h-screen bg-gray-100 flex items-center justify-center">
               ...
               <div className="w-1/2 p-8">
                    ...
                    <Image width={50} height={50}  src="/logo/logo.png" alt="Insight Logo" className="mb-4" />
                    <h2 className="text-[1.2rem] font-bold text-blue-800 mb-2">INSIGHT</h2>
                    ...
                    <form className="w-full">
                         <div className="mb-4">
                         <input type="text" placeholder="Enter your username" className="w-full px-4 py-2 border rounded-md text-sm text-gray-700 outline-none" />
                         </div>
                         <div className="mb-4">
                         <input type="password" placeholder="Password" className="w-full px-4 py-2 border rounded-md text-sm text-gray-700 outline-none" />
                         </div>
                         <div className="flex items-center justify-between mb-4">
                         <label className="flex items-center text-sm text-gray-600">
                         <input type="checkbox" className="form-checkbox text-blue-600 outline-none" />
